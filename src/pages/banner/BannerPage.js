...
const BannerPage = () => {
    ...
    const [viewStyle, setViewStyle] = useState(localStorage.getItem("bannerView") ? localStorage.getItem("bannerView") : "list");
                            ...
                            <Row>
                                {
                                    list.map((item, index) => {
                                        ...
                                        return <Col key={index} xl={4} md={6} sm={12} key={index}>
                                            <Card >
                                                <img src={item.image} className='img-thumbnail' style={{ width: '100%' }} />
                                                <h4>{item.title}</h4>
                                            </Card>
                                        </Col>
        ...
        <div className="page-content">
            ...
            <Container fluid>
                ...
                <Row>
                    ...
                    <BreadcrumbsBanner maintitle="Banner" breadcrumbItem="Banner list" lisener={(vStyle) => {
                        setViewStyle(vStyle);
                    }} />
