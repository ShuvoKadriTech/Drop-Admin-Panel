...
export const IMAGE_GALLEY_LIST_REQUEST_SUCCESS = "IMAGE_GALLEY_LIST_REQUEST_SUCCESS";
...
export const IMAGE_FOLDER_ADD_REQUEST_SUCCESS = "IMAGE_FOLDER_ADD_REQUEST_SUCCESS";
